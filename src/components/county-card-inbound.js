  ...
  render() {
    ...
    return (
      <div className="county-data-card">
        <h1>Where are people coming from?</h1>
        <Sankey isReverse={true} data={data.totals} name={data.name} />
        {
          // maxCounties > -1
          true
           ?
          <div>
            <h1>Which counties did they come from?</h1>
            <div  className="flex">
              <div style={{flex: 2}}>
        ...
        }
        {
          ...
          ?
          <div>
            <h1>Which states did they come from?</h1>
            <div  className="flex">
              <div style={{flex: 2}}>
