...
const inflowRaw = fs.readFileSync(__dirname + '/../src/data/countyinflow1516.csv').toString();
...
// console.log(inflowFiltered);

fs.writeFileSync(__dirname + '/../src/data/countyinflow-filtered.json', JSON.stringify(inflowFiltered));
...
fs.writeFileSync(__dirname + '/../src/data/countyinflow-processed.json', JSON.stringify(inflowProcessed));