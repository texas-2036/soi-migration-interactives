...
const outflowRaw = fs.readFileSync(__dirname + '/../src/data/countyoutflow1415.csv').toString();
...
fs.writeFileSync(__dirname + '/../src/data/countyoutflow-processed-prev.json', JSON.stringify(outflowProcessed));